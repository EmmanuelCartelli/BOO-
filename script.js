...
function colorizedInBlack(){
    ...
    let arrayBlack = [516, 517, 518, 519, 520, 521, 614, 615, 622, 623, 713, 724, 812, 912, 1011, 1111, 1211, 1310, 1410, 1510, 1611, 1712, 1713, 1714, 1815, 1816, 1817, 1918, 1919, 1920, 1821, 1822, 1823, 1724, 1625, 1525, 1426, 1326, 1226, 1126, 1026, 925, 825, 724, 623, 622, 1314, 1213, 1113, 1014, 1015, 1116, 921, 1021, 923, 1023];
    ...
    for(j of allElements){
        ...
        if(arrayGrey.includes(parseInt(j.classList[1]))){
            j.setAttribute("style", "background-color: grey");
        }
